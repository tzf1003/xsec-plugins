...
class FactoryFinalCandidateGateWorkflowTests(unittest.TestCase):
    ...
    def test_final_gate_revalidates_narrow_adoption_and_sidecar_candidates(self) -> None:
        ...
        self.assertIn("xsec-marketplace/external-beta-*|xsec-marketplace/batch-*", workflow)
        self.assertIn("Only external Beta or source-batch branches may reopen a no-pointer Desktop smoke cycle", workflow)
